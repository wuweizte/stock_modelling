...
```{r main 1.3, fig.height=6, fig.width=10, echo = FALSE, cache=TRUE,eval=FALSE}
...
```{r main 1.6, echo=FALSE,eval=FALSE}
### 2 sigma upper level
...
```{r main 1.7,  fig.height=3, fig.width=4, echo=FALSE,eval=FALSE}
...
```{r appendix 1.3.2, fig.height=2, fig.width=9, echo = FALSE, cache=FALSE,eval=FALSE}
...
```{r main 2.1, echo = FALSE,eval=FALSE}
...
```{r main 2.2, fig.height=6, fig.width=10, echo = FALSE, cache=TRUE,eval=FALSE}
...
```{r main 2.3, fig.height=6, fig.width=10, echo = TRUE, cache=TRUE,eval=FALSE}
...
```{r main 2.3(2), fig.height=6, fig.width=10, echo = TRUE, cache=TRUE,eval=FALSE}
...
```{r main 2.4, echo=FALSE,eval=FALSE}
### 2 sigma upper level
...
```{r main 2.5,  fig.height=3, fig.width=4, echo=FALSE,eval=FALSE}
...
```{r main 2.3.1,  fig.height=3, fig.width=4, echo=FALSE,eval=FALSE}
...
```{r appendix 2.3.2, fig.height=2, fig.width=9, echo = FALSE, cache=FALSE,eval=FALSE}
recent.week.count <- 5
...
```{r 3.0.1, cache=FALSE, eval=TRUE,eval=FALSE}
...
```{r 3.0.2, cache=FALSE, eval=TRUE,eval=FALSE}
...
```{r 3.1.1, cache=FALSE, eval=TRUE,eval=FALSE}
...
```{r 3.1.2, cache=FALSE,eval=FALSE}
...
```{r main 3.2.1, fig.height=6, fig.width=10, cache=FALSE,eval=FALSE}
...
```{r main 3.2.2, fig.height=6, fig.width=10, cache=FALSE,eval=FALSE}
...
```{r main 3.3.1, fig.height=6, fig.width=10,eval=FALSE}
...
```{r main 3.3.2, fig.height=6, fig.width=10,eval=FALSE}
...
```{r 3.4.1, fig.height=6, fig.width=10,eval=FALSE}
...
```{r 3.4.2, fig.height=6, fig.width=10,eval=FALSE}
...
```{r Monthly Verification 3.6.1,eval=FALSE}
# iid test
...
```{r Monthly Verification 3.6.2,eval=FALSE}
# random process test
...
```{r Monthly Verification 3.6.3,eval=FALSE}
# mean linearity test
...
```{r Monthly Verification 3.6.4,eval=FALSE}
# mean linearity test
...
```{r weekly Verification--Model, cache=FALSE,eval=FALSE}
...
```{r main 4.2, fig.height=6, fig.width=10, cache=FALSE,eval=FALSE}
...
```{r main 4.3, fig.height=6, fig.width=10,eval=FALSE}
...
```{r main 4.4, fig.height=6, fig.width=10,eval=FALSE}
...
```{r Weekly Verification 4.6.1,eval=FALSE}
# iid test 
...
```{r Weekly Verification 4.6.2,eval=FALSE}
# random process test
...
```{r Weekly Verification 4.6.3,eval=FALSE}
# mean linearity test
...
```{r Weekly Verification 4.6.4,eval=FALSE}
# mean linearity test
...
```{r appendix 5.2, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
...
```{r appendix 5.4, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
plot(myfilter.aparch.std.52.ver1, which = 3)
```


```{r appendix 5.5, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
plot(myfilter.aparch.std.52.ver1, which = 9)
```

```{r appendix 5.6, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
plot(myfilter.aparch.std.52.ver1, which = 10)
```

```{r appendix 5.7, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
plot(myfilter.aparch.std.52.ver1, which = 11)
```

```{r appendix 5.8, fig.height=8, fig.width=10, echo = TRUE, cache=FALSE,eval=FALSE}
...
```{r Weekly Verification 5.1.1,eval=FALSE}
# iid test
...
```{r Weekly Verification 5.1.2,eval=FALSE}
# random process test
...
```{r Monthly Verification 5.1.3,eval=FALSE}
# mean linearity test
...
```{r Monthly Verification 5.1.4,eval=FALSE}
# mean linearity test
