...
DrawKDJDForecastPlot <- function(arg.close.price, arg.kdj.k, arg.kdj.d, arg.forecast.period, 
        ...
        training.set.close.price <- window(close.price.data, start = 1, end = arg.training.set.endpoint)
        training.set.kdj.d <- window(kdj.d.data, start = 1, end = arg.training.set.endpoint)
