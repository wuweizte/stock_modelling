...
# training.set.close.price <- window(close.price, start = 1, end = 299)
# test.set.close.price <- window(close.price, start = 300)
# 
# 
# training.set.kdj.k <- window(kdj.k, start = 1, end = 299)
# test.set.kdj.k <- window(kdj.k, start = 300)
# 
# training.set.kdj.d <- window(kdj.d, start = 1, end = 299)
# test.set.kdj.d <- window(kdj.d, start = 300)
...
training.set.close.price <- window(close.price, start = length(close.price) - 500)
...
training.set.kdj.k <- window(kdj.k, start = length(kdj.k) - 500)
...
training.set.kdj.d <- window(kdj.d, start = length(kdj.d) - 500)
...
reg.lagged.df <- cbind(as.numeric(training.set.kdj.k),
                ...
                as.numeric(training.set.kdj.k - training.set.kdj.d), 
                ...
                ts(c(NA, NA, head(training.set.kdj.k, length(training.set.kdj.k) - 2) - 
                             head(training.set.kdj.d, length(training.set.kdj.d) - 2))),
                ...
                ts(c(NA, NA, NA, head(training.set.kdj.k, length(training.set.kdj.k) - 3) - 
                             head(training.set.kdj.d, length(training.set.kdj.d) - 3))))
...
fit.2.5 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(2,5)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.2.5.8 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(2,5,8)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.2.5.8.11 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
...
fit.1.4 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(1,4)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.1.4.7 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(1,4,7)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.1.4.7.10 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(1,4,7,10)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.3 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), 3],
                    max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.3.6 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(3,6)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.3.6.9 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
                     xreg = reg.lagged.df[4:nrow(reg.lagged.df), c(3,6,9)],
                     max.order = 9, stepwise = FALSE, approximation = FALSE)

fit.3.6.9.12 <- auto.arima(training.set.close.price[4:length(training.set.close.price)], 
