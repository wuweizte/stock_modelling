...
The actual values of the last 5 weeks are almost in the 80% prediction interval of the prediction in 2016-9-30 , and all in the 95% prediction interval. 
...
The 80% prediction interval of stock index of the next week is [3160, 3300]. So the possibility of the event that stock index is larger than 3160 is 90% and the possibility of the event that stock index is larger than 3300 is 10%, which can be treated as one type of condition of buying and selling.  
