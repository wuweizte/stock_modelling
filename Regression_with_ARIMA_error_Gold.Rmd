...
```{r appendix 2.2-2, fig.height=12, fig.width=10, echo = FALSE, cache=TRUE, eval=TRUE}
source("CompareObjectAccuracy.R")
source("CompareObjectXregAccuracy.R")
...
```{r appendix 2.2-6, fig.height=12, fig.width=10, echo = FALSE, cache=TRUE, eval=TRUE}
...
```{r appendix 2.4-2, fig.height=12, fig.width=10, echo = FALSE, cache=FALSE, eval=TRUE}
source("CompareObjectAccuracy.R")
source("CompareObjectXregAccuracy.R")
source("CompareObjectEstimated4layersXregAccuracy.R")
...
```{r appendix 2.4-3, fig.height=12, fig.width=10, echo = FALSE, cache=TRUE, eval=TRUE}
result.actual.xreg.kdj.d <-
        CompareObjectXregAccuracy(arg.object = monthly.kdj.d,
                                  arg.forecast.period = forecast.period,
                                  arg.training.set.endpoint = training.set.endpoint,
...
```{r appendix 2.8, fig.height=5, fig.width=7, echo = TRUE, cache=TRUE, eval=TRUE}
setwd("d://MyR//stock//")
...
```{r appendix 2.8(3), fig.height=5, fig.width=7, echo = TRUE, cache=TRUE, eval=TRUE}
...
```{r appendix 2.9, fig.height=5, fig.width=7, echo = TRUE, cache=TRUE, eval=TRUE}
setwd("d://MyR//stock//")
source("CompareObjectArfimaAccuracy.r")

training.set.endpoint <- length(monthly.kdj.d) - 10 - forecast.period

system.time(result.arfima.10 <- CompareObjectArfimaAccuracy(arg.object = monthly.kdj.d,
                                                 arg.forecast.period = forecast.period,
                                                 arg.training.set.endpoint = training.set.endpoint,
...
system.time(result.pure.kdj.d.10 <- CompareObjectAccuracy(arg.object = monthly.kdj.d,
                                                 arg.forecast.period = forecast.period,
                                                 arg.training.set.endpoint = training.set.endpoint,
                                                 arg.comparison.period = 10,
                                                 arg.maxorder = maxorder))
...
```{r appendix 2.9(2), fig.height=5, fig.width=7, echo = TRUE, cache=FALSE, eval=TRUE}
t.test(result.pure.kdj.d.10$RMSE - result.arfima.10$RMSE)

summary(result.pure.kdj.d.10$RMSE)

summary(result.arfima.10$RMSE)
