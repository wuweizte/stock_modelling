...
For predicting kdj.k using dynamic Arima model with estimated kdj.d, some chosen ARIMA models is (0,0,0), which means that kdj.k is simply replaced by estimated kdj.d. So kdj.d is not a good predictor.
